...
public class IntraDayCoverLimitPrice {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(10000);
				...
				//Click on Cover
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@class='MuiButtonBase-root MuiTab-root MuiTab-textColorPrimary  col-xl-2 text-capitalize css-zytga1' and starts-with(@id,'simple-tab-2')]"))).click();
		
				
				//Increase the Quantity ( Units )
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"simple-tabpanel-2\"]/div/div/div[1]/div[1]/div[1]/div[2]/img"))).click();
				...
				//Clear Default Price
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-2']/div/div/div[1]/div[2]/input"))).clear();
				//Enter Price
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='simple-tabpanel-2']/div/div/div[1]/div[2]/input"))).sendKeys("12");
